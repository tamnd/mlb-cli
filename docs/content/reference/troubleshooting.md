...
Most of these come down to network reality or how mlb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mlb rate-limits like any public site. mlb already paces
...
Where a surface is gated, mlb reads a cookie or token you supply
...
`mlb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mlb actually did
