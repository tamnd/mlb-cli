...
func TestHostWiring(t *testing.T) {
	...
	if want := "mlb://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("mlb", "about")
	if err != nil || got.String() != "mlb://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want mlb://page/about", got.String(), err)
	}
}
